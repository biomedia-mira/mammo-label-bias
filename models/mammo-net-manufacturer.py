...
class MammoDataset(Dataset):
    def __init__(self, data, image_size, image_normalization, horizontal_flip = False, augmentation = False, cache_size = 0):
        ...
        self.labels = data.manufacturer_label.to_numpy()
...
class EMBEDMammoDataModule(pl.LightningDataModule):
    def __init__(self, data_dir, csv_file, image_size, test_percent, val_percent, batch_alpha, batch_size, num_workers):
        ...
        # Define manufacturer categories
        self.data['manufacturer_label'] = 0
        self.data.loc[self.data['Manufacturer'] == 'HOLOGIC, Inc.', 'manufacturer_label'] = 0
        self.data.loc[self.data['Manufacturer'] == 'GE MEDICAL SYSTEMS', 'manufacturer_label'] = 1
        self.data.loc[self.data['Manufacturer'] == 'FUJIFILM Corporation', 'manufacturer_label'] = 2
        self.data.loc[self.data['Manufacturer'] == 'GE HEALTHCARE', 'manufacturer_label'] = 3
