...
class EMBEDMammoDataModule(pl.LightningDataModule):
    def __init__(self, data_dir, csv_file, image_size, test_percent, val_percent, batch_alpha, batch_size, num_workers):
        ...
        if num_classes == 4:
            ...
            self.data.loc[self.data['tissueden'] == 1, 'density_label'] = 0
            self.data.loc[self.data['tissueden'] == 2, 'density_label'] = 0
            self.data.loc[self.data['tissueden'] == 3, 'density_label'] = 1
            self.data.loc[self.data['tissueden'] == 4, 'density_label'] = 1
